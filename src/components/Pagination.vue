<template>
  <section class="border-b border-mute-light container mx-auto max-w-lg px-6 md:px-8 py-16">
      ...
      <ul class="list-reset flex items-center justify-between sm:text-lg lg:text-xl">
        <li class="lg:w-1/5">
          <g-link
            ...
            class="text-default hover:text-primary px-4 py-2 no-underline transition-color"
            :rel="info.currentPage == 1 ? 'nofollow' : 'prev'"
          >&larr; Previous</g-link>
        </li>
        <li
          class="hidden md:flex w-auto text-center text-default text-base"
